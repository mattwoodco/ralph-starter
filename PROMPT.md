...
Start the dev server if needed (e.g., `bun dev`, `python3 -m http.server`, etc.). If port is taken, try another port.
...
1. Navigate to the local server URL (if applicable)
